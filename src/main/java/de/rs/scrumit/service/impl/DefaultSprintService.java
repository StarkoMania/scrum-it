...
public class DefaultSprintService implements SprintService {
	...
	@Autowired
	private BaseEntityCRUDDao crudDao;
	
	@Override
	public SprintModel getSprint(String code) {
		return crudDao.getByCode(SprintModel.class, code);
	}
	
	@Override
	public void updateSprint(SprintModel sprint) {
		crudDao.update(sprint);
	}

	@Override
	public void createSprint(SprintModel sprint) {
		crudDao.save(sprint);
	}
